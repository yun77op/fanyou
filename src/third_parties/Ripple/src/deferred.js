...
Deferred.next_faster_way_readystatechange = ((typeof window === 'object' && window.location) && (window.location.protocol == "http:") && !window.opera && /\bMSIE\b/.test(navigator.userAgent)) && function (fun) {
	var d = new Deferred();
	var t = Date.now();
